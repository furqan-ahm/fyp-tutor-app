...
class AssignmentsReview extends StatefulWidget {
  const AssignmentsReview({Key? key}) : super(key: key);

  @override
  _AssignmentsReviewState createState() => _AssignmentsReviewState();
}

class _AssignmentsReviewState extends State<AssignmentsReview> {
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: MaxSizedContainer(
            ...
            child: Column(
              children: [
                const CustomAppBar(title: 'Past Assignments'),
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  const Spacer(),
                                                  assignments[index].points!=null?Column(
                                                    crossAxisAlignment: CrossAxisAlignment.end,
                                                    children: [
                                                      Row(children: [
                                                        const Text('Obtained Points: ', style: TextStyle(fontWeight: FontWeight.bold),),
                                                        Text('${assignments[index].obtained}'),
                                                      ],),
                                                      Row(children: [
                                                        const Text('Total Points: ', style: TextStyle(fontWeight: FontWeight.bold),),
                                                        Text('${assignments[index].points}'),
                                                      ],)
                                                    ],
                                                  ):const SizedBox.shrink(), const SizedBox(width: 4,)
                                                ],
                                              ),
